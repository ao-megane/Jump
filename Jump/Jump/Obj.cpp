...
//	return 0;
//}
int imageSquareMng::Born(double a[], int num) {//num‚ÍSQU_NUM‚æ‚è¬‚³‚¢‚±‚Æ,num‚ÍlŠp‚Ì”
	for (int i = 0; i < num; i++) {
...
int imageSquareMng::Born(double a,double b,double c,double d) {//num‚ÍSQU_NUM‚æ‚è¬‚³‚¢‚±‚Æ,num‚ÍlŠp‚Ì”
	for (int i = 0; i < SQU_NUM; i++) {
