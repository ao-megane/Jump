...
int StageUpdata(int stagenum, int count, int enemyExist,Dot pcenter) {//ëÂëÃÇÃÉXÉeÅ[ÉWÇ≈Ç¢ÇÁÇ»Ç¢Ç©Ç‡
	/*switch (stagenum)
	{
	case 0:
		break;
	...
	if (stagenum > 4) {//çHèÍånÇ»ÇÁ
		if (enemyExist) {//ìGÇ™Ç¢ÇÍÇŒ
...
int DrawStage(int count) {//countìnÇ∑ïKóvÇ»Ç¢Ç©Ç‡
