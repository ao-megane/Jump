...
int StageLoad(int stagenum) {
	...
	case 0:	//stage1
		...
		Walls_view.SetWalls(STAGE1_view, STAGE1_view_NUM, stagenum, Tutorial_wall_1, Tutorial_wall_2, Tutorial_wall_3, Tutorial_wall_4, 0);
		//dynamicWall.Born();
		Limit = STAGE1_COUNT;
	...
	case 1:
		...
		Walls_view.SetWalls(STAGE2_view, STAGE2_view_NUM, stagenum, Tutorial_wall_1, Tutorial_wall_2, Tutorial_wall_3, Tutorial_wall_4, 0);
		//dynamicWall.Born();
		Limit = STAGE2_COUNT;
		Door.Set(DISP_WIDTH - 120, DISP_HEIGHT - 180, DISP_WIDTH - 60, DISP_HEIGHT - 60);
		Door.Setimage(Doorimage);
	...
	case 2:
		...
		Walls_view.SetWalls(STAGE3_view, STAGE3_view_NUM, stagenum, Tutorial_wall_1, Tutorial_wall_2, Tutorial_wall_3, Tutorial_wall_4, 0);
		//dynamicWall.Born();
		Limit = STAGE3_COUNT;
		Door.Set(DISP_WIDTH - 120, DISP_HEIGHT - 180, DISP_WIDTH - 60, DISP_HEIGHT - 60);
		Door.Setimage(Doorimage);
	...
	case 3:
		...
		Walls_view.SetWalls(STAGE4_view, STAGE4_view_NUM, stagenum, Tutorial_wall_1, Tutorial_wall_2, Tutorial_wall_3, Tutorial_wall_4, 0);
		//dynamicWall.Born();
		//printfDx("aaaaaaaaaa");
		Limit = STAGE4_COUNT;
		Door.Set(DISP_WIDTH - 120, DISP_HEIGHT - 180, DISP_WIDTH - 60, DISP_HEIGHT - 60);
	...
	case 4:
		...
		Walls_view.SetWalls(STAGE5_view, STAGE5_view_NUM, stagenum, Tutorial_wall_1, Tutorial_wall_2, Tutorial_wall_3, Tutorial_wall_4, 0);
		//dynamicWall.Born();
		Limit = STAGE1_COUNT;
		Door.Set(DISP_WIDTH - 120, DISP_HEIGHT - 180, DISP_WIDTH - 60, DISP_HEIGHT - 60);
		Door.Setimage(Doorimage);
	...
	case 5:
		...
		Walls_judge.Add(STAGE5_judge, STAGE5_judge_NUM);
		Walls_view.SetWalls(STAGE6_view, STAGE6_view_NUM, stagenum, Factory_wall_1, Factory_wall_2, Factory_wall_3, Factory_wall_4, Factory_wall_5);
		//dynamicWall.Born();
		Limit = STAGE1_COUNT;
		Door.Set(DISP_WIDTH - 120, DISP_HEIGHT - 180, DISP_WIDTH - 60, DISP_HEIGHT - 60);
		Door.Setimage(Doorimage);
	...
	case 6:
		BackGround = Factory_back;
		Walls_judge.Add(STAGE5_judge, STAGE5_judge_NUM);
		Walls_view.SetWalls(STAGE7_view, STAGE7_view_NUM, stagenum, Factory_wall_1, Factory_wall_2, Factory_wall_3, Factory_wall_4, Factory_wall_5);
		//dynamicWall.Born();
		Limit = STAGE1_COUNT;
		Door.Set(DISP_WIDTH - 120, DISP_HEIGHT - 180, DISP_WIDTH - 60, DISP_HEIGHT - 60);
		Door.Setimage(Doorimage);
	...
	case 7:
		...
		Walls_view.SetWalls(STAGE5_view, STAGE5_view_NUM, stagenum, Factory_wall_1, Factory_wall_2, Factory_wall_3, Factory_wall_4, Factory_wall_5);
		//dynamicWall.Born();
		Limit = STAGE1_COUNT;
		Door.Set(DISP_WIDTH - 120, DISP_HEIGHT - 180, DISP_WIDTH - 60, DISP_HEIGHT - 60);
		Door.Setimage(Doorimage);
